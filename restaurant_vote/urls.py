...
urlpatterns = [
    ...
    path('restaurants/<uuid:pk>/edit/', RestaurantEditView.as_view(), name='restaurant-edit'),
    path('restaurants/<uuid:pk>/delete/', RestaurantDeleteView.as_view(), name='restaurant-delete'),
    ...
    path('menus/<uuid:pk>/edit/', MenuUpdateView.as_view(), name='menu-edit'),
    path('menus/<uuid:pk>/delete/', MenuUpdateView.as_view(), name='menu-delete'),
